...
export default function TaskPage() {
  ...
  const sortedTasks = [...dummyTasks].sort((a, b) => {
    ...
    <div className="flex-1 ml-[20vw] pb-16 pr-6 flex flex-col text-indigo-600 dark:text-gray-100 gap-2">
      ...
      <div className="flex gap-2">
        {Object.entries(taskCounts).map(([status, count]) => (
          <div key={status} className="flex items-center w-[19%] border border-gray-400 dark:border-gray-50/20 bg-white px-4 rounded-xl dark:bg-gray-800/50 shadow-xs hover:bg-gray-100 dark:hover:bg-gray-400 hover:text-indigo-700 dark:hover:text-blue-200 cursor-pointer">
      ...
      <div className="flex items-center justify-between pr-8 mt-4">
        <Link href="/" className="flex items-center justify-start gap-2 border border-gray-400 rounded-md px-2 py-2 shadow-xs bg-white hover:bg-gray-100 dark:hover:bg-gray-400 dark:hover:text-blue-200 dark:bg-transparent">
          <LayoutGrid size={16} className='dark:text-gray-100 text-gray-400' />
        </Link>
        <button className="flex items-center justify-end border gap-2 py-1 rounded-xl border-gray-400 px-2 text-gray-500 shadow-xs text-sm dark:text-gray-400 dark:bg-transparent bg-white hover:bg-gray-100 dark:hover:bg-gray-400 dark:hover:text-blue-200">
          <Filter size={16} />
          Filters
        </button>
      </div>
